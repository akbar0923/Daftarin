...
public class form_pubg_e2c extends javax.swing.JFrame {
    ...
    private void printPDF() {
        try {
            String nama = "D:\\Hasil Cetak\\Data Lomba PUBGM E2C.pdf"; 
            ...
            String query = "SELECT * FROM pubg_e2c";
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
            
            Paragraph paragraph1 = new Paragraph("Data Pendaftar Lomba PUBG Mobile Engineering Esport Competition");
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Scrollbar, javax.swing.GroupLayout.PREFERRED_SIZE, 497, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel1.setText("PUBG MOBILE E2C");
    ...
    private void btnSubmitDataPUBGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitDataPUBGActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO pubg_e2c VALUES('" + txtNoInduk.getText() + "','" + txtNamaTeamPUBG.getText() + "','" + txtNamaLeaderPUBG.getText() + "','" + txtNoWAPUBG.getText() + "','" + txtNamaPlayerPUBG1.getText() + "','" + txtNickPUBG1.getText() + "','" + txtIDPUBG1.getText() + "','" + txtNamaPlayerPUBG2.getText() + "','" + txtNickPUBG2.getText() + "','" + txtIDPUBG2.getText()
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE PUBG_e2c set Nomor_induk = '"+ txtNoInduk.getText() +"', Nama_Team = '"+ txtNamaTeamPUBG.getText() + "', Nama_Leader = '" + txtNamaLeaderPUBG.getText() + "', No_Wa = '" + txtNoWAPUBG.getText() 
            ...
            // String sql = "INSERT INTO pubgm VALUES('"+ txtNamaTeamPUBG.getText() + "','" + txtNamaLeaderPUBG.getText() + "','" + txtNoWAPUBG.getText() + "','" + txtNamaPlayerPUBG1.getText() + "','" + txtNickPUBG1.getText() + "','" + txtIDPUBG1.getText() + "')";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        try {
        String sql = "DELETE FROM pubg_e2c WHERE Nomor_induk='"+txtNoInduk.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_pubg_e2c.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_pubg_e2c().setVisible(true);
            }
        });
    }
