...
public class form_pubg_rektorcup extends javax.swing.JFrame {
    ...
    private void printPDF() {
        try {
            String nama = "D:\\Hasil Cetak\\Data Lomba PUBGM Rektor Cup.pdf"; 
            ...
            String query = "SELECT * FROM pubg_rektorcup";
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
            
            Paragraph paragraph1 = new Paragraph("Data Pendaftar Lomba PUBG Mobile Rektor Cup");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PUBG MOBILE REKTOR CUP");
    ...
    private void btnSubmitDataPUBGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitDataPUBGActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO pubg_rektorcup VALUES('" + txtNoInduk.getText() + "','" + txtNamaTeamPUBG.getText() + "','" + txtNamaLeaderPUBG.getText() + "','" + txtNoWAPUBG.getText() + "','" + txtNamaPlayerPUBG1.getText() + "','" + txtNickPUBG1.getText() + "','" + txtIDPUBG1.getText() + "','" + txtNamaPlayerPUBG2.getText() + "','" + txtNickPUBG2.getText() + "','" + txtIDPUBG2.getText()
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE PUBG_rektorcup set Nomor_induk = '"+ txtNoInduk.getText() +"', Nama_Team = '"+ txtNamaTeamPUBG.getText() + "', Nama_Leader = '" + txtNamaLeaderPUBG.getText() + "', No_Wa = '" + txtNoWAPUBG.getText() 
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        try {
        String sql = "DELETE FROM pubg_rektorcup WHERE Nomor_induk='"+txtNoInduk.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_pubg_rektorcup().setVisible(true);
            }
        });
    }
